...
final class Dog {
    ...
    /// Diary entries — one per Moment unlocked in the journey. Generated by
    /// LLMService at unlock time and persisted so the user can re-read past
    /// Moments in the Journey tab.
    @Relationship(deleteRule: .cascade)
    var momentDiary: [MomentDiaryEntry]? = []
